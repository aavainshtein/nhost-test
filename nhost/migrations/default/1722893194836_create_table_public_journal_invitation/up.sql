CREATE TABLE "public"."journal_invitation" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), "email" text NOT NULL, "journal_id" uuid NOT NULL, "is_fulfilled" boolean NOT NULL DEFAULT false, "author_id" uuid NOT NULL, "user_id" uuid, PRIMARY KEY ("id") , FOREIGN KEY ("journal_id") REFERENCES "public"."journal"("id") ON UPDATE restrict ON DELETE restrict, UNIQUE ("journal_id", "email"));COMMENT ON TABLE "public"."journal_invitation" IS E'if there is no user then there will be record';
